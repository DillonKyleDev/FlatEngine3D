...
namespace FlatEngine 
{
	...
	bool RenderImageButton(std::string ID, VkDescriptorSet texture, Vector2 size, float rounding, Vector4 bgColor, Vector4 tint, Vector4 hoverColor, Vector4 activeColor, Vector2 uvStart, Vector2 uvEnd, Vector2 padding)
	{
